...
<td bgcolor="#000048"><span class="style1"><a href="#"onClick="logout()"><strong>- Logout</strong></a></span></td>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">INPUT NAMA KOTA
        </div>
  ...
  $id		= $_GET['id'];
  $edit		= "select * from kota where id_kota=$id";
  $hasil	= mysql_query ($edit);
  $c		= mysql_fetch_array ($hasil);
  ?>
      <tr>
        <td width="144"><small>KOTA</small></td>
        </tr>
      <tr>
        <td><input name="kotai" type="text" id="kota"  value="<?php echo $c['nama_kota']?>"></td>
        </tr>
      <tr>
