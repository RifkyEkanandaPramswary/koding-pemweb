...
<td bgcolor="#000048"><span class="style1"><a href="#"onClick="logout()"><strong>- Logout</strong></a></span></td>
      ...
      <td width="753" height="250" align="left" bgcolor="#FFFFFF"><div align="center">KOTA
        </div>
        ...
        <tr>
          <td>&nbsp;</td>
          <td><p align="left"><a href="input_kota.php">+ Tambah Kota</a></p>
            <p>
              <?php
include "../koneksi.php";

$query = "select * from kota where 10";
...
?>
            <table border="0">
              <tr bgcolor="#B0B0B0">
                <th width="55">NO</th>
                <th width="115">NAMA KOTA</th>
                <th width="55"><small>AKSI</small></th>
              </tr>
              <?php
$no=1;
...
?>
              <tr bgcolor="#E4E4E4">
                ...
                <td><small><?php echo $data['nama_kota']; ?></small></td>
                <td><small><a href="hapus_kota.php?id=<?php echo $data['id_kota']; ?>" 
	onClick = "return confirm('Apakah Anda ingin mengapus data <?php echo $data['id_kota']; ?>?')"> Hapus </a> | <a href="edit_kota.php?id=<?php echo $data['id_kota']; ?>" >Edit</a> </small></td>
              </tr>
              <?php
$no++;
}
?>
    ...
    <tr align="center" valign="middle" bgcolor="#000099">
      <td colspan="2"><span class="style1">&copy; 2016 Team UTS<br>
Created by Arifin &amp; Team</span></td>
    </tr>
  </table>
</div>
</body>
